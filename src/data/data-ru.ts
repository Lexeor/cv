  ...
  projects: [
    {
      ...
      solution: [
        "Для реализации проекта был выбран фреймворк Payload CMS, подключенный к облачной базе данных MongoDB.",
        "Разработано в команде из 2 человек.",
        ...
        "Сервис развёрнут на облачном сервере с помощью Docker Compose и Nginx.",
      ],
  ...
  projectsPrint: [
    {
      ...
      date: "Май 2023",
      description: [
        "Написан на JavaScript и мигрирован на TypeScript. Адаптивный веб-дизайн в комплекте.",
    ...
    },
    {
      ...
      description: [
        ...
        "Данные о погоде и УФ-индексе, собираются из бесплатных API и объединяются на API прокси-сервере, чтобы обойти ограничение на количество бесплатных API вызовов.",
